...
unimportant_dates = which(as.Date(SAHdates_withdata$date) == as.Date(SAHdates_withdata$EFF_DATE) | as.Date(SAHdates_withdata$date) - as.Date(SAHdates_withdata$EFF_DATE) == 21)

impdates = CD_mobility[-unimportant_dates,]
