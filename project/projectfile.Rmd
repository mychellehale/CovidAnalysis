...
#Focus on key dates
unimportant_dates = which(as.Date(SAHdates_withdata2$date) != as.Date(SAHdates_withdata2$EFF_DATE) & (as.Date(SAHdates_withdata2$date) - as.Date(SAHdates_withdata2$EFF_DATE) != 21)) #Only have dates for a state based on day of stay at home order and 3 weeks after.
impdates = SAHdates_withdata2[-unimportant_dates,]

pseudoSAH_dates =  which((impdates$date != "2020-04-08" & impdates$date != "2020-04-29") & (impdates$state == "Wyoming" | impdates$state == "Utah" | impdates$state == "South Dakota" | impdates$state == "Oklahoma" | impdates$state == "North Dakota" | impdates$state == "Nebraska" |impdates$state == "Iowa" | impdates$state == "Arkansas" |impdates$state == "Guam" | impdates$state == "Northern Mariana Islands" | impdates$state == "Puerto Rico" | impdates$state == "Virgin Islands")) #For locations where we don't have SAHOrder data
...
cov19_project = subset(allmerged,select=c("fips","state","case_change","percent_low_birthweight","percent_smokers","primary_care_physicians_rate","percent_vaccinated","num_households","average_daily_pm2_5","life_expectancy","child_mortality_rate","infant_mortality_rate","percent_food_insecure","median_household_income","average_traffic_volume_per_meter_of_major_roadways","population_2","percent_65_and_over","percent_rural","percent_uninsured","retail_and_rec_pctpoint_change","grocery_and_pharmacy_pctpoint_change","parks_pctpoint_change","transit_stations_pctpoint_change","workplaces_pctpoint_change","residential_pctpoint_change", "average_traffic_volume_per_meter_of_major_roadways"))

cov19_project_nm = subset(allmerged,select=c("fips","state","case_change","deathmonth","percent_low_birthweight","percent_smokers","primary_care_physicians_rate","percent_vaccinated","num_households","average_daily_pm2_5","life_expectancy","child_mortality_rate","infant_mortality_rate","percent_food_insecure","median_household_income","population_2","percent_65_and_over","percent_rural","percent_uninsured"))
