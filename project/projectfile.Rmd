...
cov19_project = subset(allmerged,select= c("casesmonth","deathmonth","retail_recreation","grocery_pharmacy","parks","transit_stations","workplaces","residential","percent_low_birthweight","percent_smokers","primary_care_physicians_rate","percent_vaccinated","percent_some_college","num_households","average_daily_pm2_5","life_expectancy","child_mortality_rate","infant_mortality_rate","percent_food_insecure","median_household_income","average_traffic_volume_per_meter_of_major_roadways","population_2","percent_65_and_over","percent_rural","percent_uninsured"))
...
ggpairs(cov19_project, columns = c(1, 15:20))
ggpairs(cov19_project, columns = c(1, 21:25))
```
...
ggpairs(cov19_project, columns = c(2, 15:20))
ggpairs(cov19_project, columns = c(2, 21:25))
```
